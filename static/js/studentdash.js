document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadContent(section) {
        ...
        // Update header title
        const icon = section === 'mis-cursos' ? 'book' : 
                     //section === 'inicio' ? 'home' :
                     //section === 'cursos-disponibles' ? 'search' :
                     section === 'mis-certificados' ? 'graduation-cap' :
                     section === 'documentacion' ? 'book-open-reader' : 
                     section === 'mi-perfil' ? 'user' : 'book';
